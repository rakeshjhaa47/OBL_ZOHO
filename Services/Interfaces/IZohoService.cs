...
namespace OBL_Zoho.Services.Interfaces
{
    public interface IZohoService
    {
        ...
        Task<BaseResponse> GetLeadsForAsync(string refreshToken, string? ZM_Code, string? ZH_Code, string? BM_Code, string? Sales_Person_Emp_ID);
        ...
        Task<BaseResponse> ClosedWonAsync(string refreshToken, string? ZM_Code, string? ZH_Code, string? BM_Code, string? Sales_Person_Emp_ID, string Start_Date, string End_Date);
