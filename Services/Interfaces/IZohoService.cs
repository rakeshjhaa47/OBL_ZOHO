...
namespace OBL_Zoho.Services.Interfaces
{
    public interface IZohoService
    {
        ...
        Task<BaseResponse> getLeadsByStageAsync(string refreshToken, string Stage_Category , string Sales_Person_Email_ID , string Created_Time, string MaxAreasqft, string MinAreaSqFt, bool isEmployee,int offSet,int limit);
